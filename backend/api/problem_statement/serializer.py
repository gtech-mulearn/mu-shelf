...
class Problem_statement_serializer(serializers.ModelSerializer):
    class Meta:
        ...
        fields = ['id', 'title', 'description', 'reward','organization', 'end', 'created_at', 'updated_at', 'created_by']
...
class Problem_statement_detail_serializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = ProblemStatement
        fields = ['id', 'title', 'description', 'reward', 'organization', 'end', 'created_at', 'updated_at', 'created_by', 'approved', 'solutions',]